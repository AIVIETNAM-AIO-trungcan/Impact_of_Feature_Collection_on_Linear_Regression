...
def run_pipeline():
    try:
        ...
        # ---------------------------------------------------------
        # Purpose:
        #   - Convert model predictions back to original Rupee currency.
        #   - Calculate advanced metrics (MAE, MAPE, RMSE).
        #   - Log model context (Method/Features) for experiment tracking.
        # ---------------------------------------------------------
